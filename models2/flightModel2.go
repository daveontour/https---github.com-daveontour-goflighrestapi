...
// 	fwb.WriteString(fmt.Sprintf("\"FlightKind\":\"%s\",", d.FlightKind))
// 	fwb.WriteString(fmt.Sprintf("\"FlightNumber\":\"%s\",", d.FlightNumber))
// 	fwb.WriteString(fmt.Sprintf("\"ScheduledDate\":\"%s\",", string(d.ScheduledDate)))
...
// 				fwb.WriteString(",")
// 			}
// 			fwb.WriteString(fmt.Sprintf("\"%s\":\"%s\"", apt.CodeContext, apt.Text))
// 		}
// 	}
// 	fwb.WriteString("}")
...
// 				fwb.WriteString(",")
// 			}
// 			fwb.WriteString(fmt.Sprintf("\"%s\":\"%s\"", al.CodeContext, al.Text))
// 		}
// 	}
...
// 	fwb.WriteString(fmt.Sprintf("{\"%s\":\"%s\"}", d.PropertyName, d.Text))
// 	return nil
// }
...
// 	// fid, _ := d.FlightId.MarshalJSON(fwd)
// 	// if fid == nil {
// 	// 	fwb.WriteString("}")
// 	// 	return nil
// 	// }
...
// 				fwb.WriteString(",")
// 			}
// 			fwb.WriteString(fmt.Sprintf("\"%s\":\"%s\"", tc.CodeContext, tc.Text))
// 		}
// 	}
...
// 		fwb.WriteString(fmt.Sprintf("\"SequenceNumber\":\"%s\",", rvp.SequenceNumber))
...
// 	fwb.WriteString("{")
// 	if r.CustomsType != "" {
// 		fwb.WriteString(fmt.Sprintf("\"CustomType\":\"%s\",", r.CustomsType))
// 	}
...
// 				fwb.WriteString(",")
// 			}
// 			fwb.WriteString(fmt.Sprintf("\"%s\":\"%s\"", v.PropertyName, v.Text))
// 		}
...
// 			fwb.WriteString(",")
// 			fwb.WriteString(fmt.Sprintf("\"Area%s\":\"%s\"", v.PropertyName, v.Text))
// 		}
// 		fwb.WriteString("}")
...
// 	fwb.WriteString(fmt.Sprintf("{\"AircraftId\": {\"Registration\": \"%s\"}}", d.AircraftId.Registration))
...
// 		}
// 		set = true
// 		fwb.WriteString(fmt.Sprintf("\"%s\":\"%s\"", f.PropertyName, strings.Replace(f.Text, "\n", "", -1)))
// 	}

// 	fwb.WriteString("}")

// }
// func (d *FlightState) WriteJSON(fwb bufio.Writer) error {
...
// 	// 	log.Fatal(err)
// 	// }
// 	//fwb = bufio.NewWriterSize(file, 2000)
// 	fwb.WriteString("{")

// 	fwb.WriteString(fmt.Sprintf("\"ScheduledTime\":\"%s\",", d.ScheduledTime))

// 	if d.LinkedFlight != nil {
...
// 	fwb.WriteString("\"Values\":")
// 	MarshalValuesArrayJSON(d.Values, fwb)
// 	fwb.WriteString(",")
...
// func (d *Flight) WriteJSON(fwb bufio.Writer) error {
...
// func (d *Flights) WriteJSON(fwb bufio.Writer) error {

// 	fwb.WriteString(`"Flights:["`)
// 	for idx, fl := range d.Flight {
// 		if idx > 0 {
// 			fwb.WriteString(`,`)
// 		}
// 		fl.WriteJSON(fwb)
